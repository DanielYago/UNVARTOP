%%%% %%%% %%%% %%%% %%%% %%%% %%%% %%%% %%%%%%%% %%%% %%%% %%%% %%%% %%%% %%%% %%%% %%%%
% A 205 line topology optimization code using the Unsmooth Variational Topology method %
%   for minimum compliance problems (multi-load problems)                              %
%   Paper's Title                                                                      %
...
% Versions                                                                             %
%   26/3/2020 - Submission version (minimum compliance - multi-load)                   %
% GitHub repository																	   %
...
%%%% %%%% %%%% %%%% %%%% %%%% %%%% %%%% %%%%%%%% %%%% %%%% %%%% %%%% %%%% %%%% %%%% %%%%
function [iter,J] = UNVARTOP_2D_multiload (nelx,nely,nsteps,Vol0,Vol,k,tau)
...
F = sparse(n_unkn*n,2);
U = zeros(n_unkn*n,2);
F(n_unkn*find(coord(:,2)==nely & coord(:,1)==nelx),1) = 0.01*nelx;
F(n_unkn*find(coord(:,2)==0 & coord(:,1)==nelx),2) = -0.01*nelx;
...
U_vec = zeros(n_unkn*size(coord,1),size(U,2),nsteps+1);
...
for i_step = 1:nsteps
	...
	if iter_step >= iter_max_step; warning('UNVARTOP_2D_multiload:Max_iter_step','Maximum number of in-step iterations achieved.'); break; end
	if iter > iter_max; warning('UNVARTOP_2D_multiload:Max_iter','Maximum number of iterations achieved.'); break; end
end
%% Animation
