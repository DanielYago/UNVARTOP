...
% Versions                                                                             %
%   26/3/2020 - Submission version (minimum compliance with Regula-Falsi method)       %
% GitHub repository																	   %
...
%%%% %%%% %%%% %%%% %%%% %%%% %%%% %%%% %%%%%%%% %%%% %%%% %%%% %%%% %%%% %%%% %%%% %%%%
function [iter,J] = UNVARTOP_2D_compliance_RF (nelx,nely,nsteps,Vol0,Vol,k,tau)
...
for i_step = 1:nsteps
	...
	if iter_step >= iter_max_step; warning('UNVARTOP_2D_compliance_RF:Max_iter_step','Maximum number of in-step iterations achieved.'); break; end
	if iter > iter_max; warning('UNVARTOP_2D_compliance_RF:Max_iter','Maximum number of iterations achieved.'); break; end
end
%% Animation
