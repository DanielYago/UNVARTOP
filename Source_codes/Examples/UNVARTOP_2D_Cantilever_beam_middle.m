...
%   for structural problems - 4.1 Cantilever beam middle                               %
%   Paper's Title																	   %
...
%%%% %%%% %%%% %%%% %%%% %%%% %%%% %%%% %%%%%%%% %%%% %%%% %%%% %%%% %%%% %%%% %%%% %%%%
function [iter,J] = UNVARTOP_2D_Cantilever_beam_middle (nelx,nely,nsteps,Vol0,Vol,k,tau)
...
F(n_unkn*find(coord(:,2)==round(0.5*nely)&coord(:,1)==nelx),1) = -0.01*nelx;
