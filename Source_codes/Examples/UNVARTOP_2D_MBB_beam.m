...
%   for structural problems - 4.2 MBB beam                                             %
%   Paper's Title																	   %
...
%%%% %%%% %%%% %%%% %%%% %%%% %%%% %%%% %%%%%%%% %%%% %%%% %%%% %%%% %%%% %%%% %%%% %%%%
function [iter,J] = UNVARTOP_2D_MBB_beam (nelx,nely,nsteps,Vol0,Vol,k,tau)
...
F(n_unkn*find(coord(:,2)==nely&coord(:,1)==0),1) = -0.01*nelx;
fixed_dofs = [reshape(n_unkn*find(coord(:,1)==0)-1,1,[]),...
              reshape(n_unkn*find(coord(:,1)==nelx&coord(:,2)==0),1,[])];
